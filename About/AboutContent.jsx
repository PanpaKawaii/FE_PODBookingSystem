    ...
    return (
        <div className='POD-about'>
            ...
            <div className='slogan-container'>
                <h1><b>Nơi làm việc lý tưởng cho sự sáng tạo và hiệu quả (logo)</b></h1>
                <h3><i>Tự hào mang đến cho bạn giải pháp tối ưu để làm việc tại bất kỳ đâu, với không gian linh hoạt và dịch vụ chất lượng cao.</i></h3>
            </div>
