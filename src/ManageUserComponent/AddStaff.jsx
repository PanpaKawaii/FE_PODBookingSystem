    ...
    useEffect(() => {
        const fetchMaxStaffId = async () => {
            try {
                ...
                const maxId = Math.max(...staffResponse.data.map(staff => staff.id), 0);
        ...
        <>
         <Form onSubmit={handleAddStaff}>
                ...
                <Form.Group controlId="formPhoneNumber">
                    ...
                    <Form.Control type="text" placeholder="Nhập số điện thoại" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
                </Form.Group>
                <Form.Group controlId="formType">
                    <Form.Label>Loại tài khoản</Form.Label>
                    <Form.Control type="text" placeholder="Nhập loại tài khoản" value={type} onChange={(e) => setType(e.target.value)} />
                </Form.Group>
                <Form.Group controlId="formPoint">
                    <Form.Label>Điểm thưởng</Form.Label>
                    <Form.Control type="number" placeholder="Nhập điểm thưởng" value={point} onChange={(e) => setPoint(e.target.value)} />
                </Form.Group>
                ...
                <Form.Group controlId="formImage">
                    ...
                    <Form.Control type="text" placeholder="Nhập URL hình ảnh" value={image} onChange={(e) => setImage(e.target.value)} />
                </Form.Group>
